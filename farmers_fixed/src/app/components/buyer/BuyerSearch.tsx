...
export function BuyerSearch() {
  ...
  return (
    <div className="space-y-6">
      <div>
        <h1 className="text-3xl font-bold text-emerald-900">Search Products</h1>
        <p className="text-emerald-600 mt-1">Find fresh produce from verified farmers and sellers</p>
      </div>
