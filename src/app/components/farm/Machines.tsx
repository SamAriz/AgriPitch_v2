  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-2xl font-bold text-[var(--text-primary)]">Farm Machinery</h1>
          <p className="text-sm text-[var(--text-muted)] mt-0.5">Manage equipment and maintenance</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
        <Card className="bg-[var(--card)] border-[var(--border-color)]">
          <CardContent className="pt-6 text-center">
            <div className="text-2xl font-bold text-[var(--text-primary)]">{mockMachines.length}</div>
        ...
        <Card className="bg-[var(--card)] border-red-200">
          <CardContent className="pt-6 text-center">
            ...
            <p className="text-sm text-[var(--text-muted)]">Maintenance</p>
          </CardContent>
        </Card>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        {mockMachines.map((machine) => (
          <Card key={machine.id} className="bg-[var(--card)] border-[var(--border-color)]">
            <CardHeader>
              <div className="flex items-start justify-between">
                <div className="flex items-center gap-3">
                  <Tractor className="w-6 h-6 text-[var(--text-muted)]" />
                  <div>
                    <CardTitle className="text-[var(--text-primary)]">{machine.name}</CardTitle>
                    <p className="text-sm text-[var(--text-muted)]">{machine.type}</p>
                  </div>
                </div>
            ...
            <CardContent className="space-y-3">
              ...
              <div className="space-y-2 text-sm">
                <div className="flex items-center gap-2">
                  ...
                  <span className="text-[var(--text-secondary)]">Last: {machine.lastMaintenance}</span>
                </div>
                <div className="flex items-center gap-2">
                  <Wrench className="w-4 h-4 text-[var(--text-muted)]" />
                  <span className="text-[var(--text-secondary)]">Next: {machine.nextMaintenance}</span>
                </div>
              </div>
